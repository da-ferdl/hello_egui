...
This fork provides:
- A simplified version of the `egui_router` - only native, no web support, but with the possibility to add an `Any` type argument to the route when navigating.<br>
